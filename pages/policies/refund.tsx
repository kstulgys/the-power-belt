  ...
  return (
    <div>
      <p>
        ...
        You’ll also need the receipt or proof of purchase. <br />
        <br />
        ...
        send you a return shipping label, as well as instructions on how and where to send your package. Items sent back to us without first requesting a return
      ...
      <p>
        ...
        automatically refunded on your original payment method. Please remember it can take some time for your bank or credit card company to process and post
        the refund too.
      </p>
    </div>
  );
